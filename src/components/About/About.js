    ...
    <section id="about">
      ...
      <div className="about-content">
        ...
        <div className="bio">
                ...
                <p>When I'm not coding, I enjoy cooking, practicing <a href="https://en.wikipedia.org/wiki/Kendo" target="_blank" rel="noopener noreferrer">kendo</a>, playing board games, and watching anime. I also love to travel and explore new cultures. I am always looking for new opportunities to learn and grow, and I am excited to see where my journey takes me next.</p>
        </div>
      </div>
    </section>
  );
